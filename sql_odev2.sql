-- 1) film tablosunda bulunan tüm sütunlardaki verileri replacement cost değeri 12.99 dan büyük eşit ve 16.99 küçük eşit olma 
-- koşuluyla sıralayınız ( BETWEEN - AND yapısını kullanınız.)

-- select * from film where replacement_cost BETWEEN 12.99 and 16.99 
-------------------------------------------------------------------------------------------------
-- 2) .actor tablosunda bulunan first_name ve sütunlardaki verileri first_name 'Penelope' veya 'Nick' veya 'Ed' değerleri 
